...
public class QRCodeUtils {
     ...
     * @return is 流
     */
    public static InputStream encoderQRCode(String content, String imgType, int size) {
        BufferedImage image = qRCodeCommon(content, imgType, size);
        ByteArrayOutputStream os = new ByteArrayOutputStream();
        try {
            ImageIO.write((BufferedImage) image, imgType, os);
        } catch (IOException e) {
            e.printStackTrace();
        }
   ...
   /* public String decoderQRCode(String imgPath) {
        ...
        try {
            ...
            content = new String(decoder.decode(new QRCodeUtils(bufImg)), "utf-8" );
        } catch (IOException e) {
  ...
  /*  public String decoderQRCode(InputStream input) {
    ...
    public static void main(String[] args) {
        String imgPath = "D:/Card.png";
        String content = "很久没吃螺蛳粉了" ;
